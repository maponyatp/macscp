    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[60] p-8"
            >
                <motion.div
                    ...
                    className="w-full max-w-2xl bg-zinc-900/90 backdrop-blur-xl border border-white/10 shadow-2xl rounded-2xl flex flex-col max-h-[80vh]"
                >
                    {/* Header */}
